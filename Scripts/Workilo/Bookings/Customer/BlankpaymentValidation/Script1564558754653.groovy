...
js.executeScript('arguments[0].style.border=\'3px solid red\'', driver.findElement(By.xpath("//*[@id='open_form_card']/div[1]/div/div[1]/small")))

js.executeScript('arguments[0].style.border=\'3px solid red\'', driver.findElement(By.xpath("//*[@id='open_form_card']/div[1]/div/div[2]/div/small")))

js.executeScript('arguments[0].style.border=\'3px solid red\'', driver.findElement(By.xpath("//*[@id='open_form_card']/div[2]/div/div[1]/small")))

js.executeScript('arguments[0].style.border=\'3px solid red\'', driver.findElement(By.xpath("//*[@id='open_form_card']/div[2]/div/div[2]/small")))
...
driver.findElement(By.xpath("//*[@id='myModal']/div/div/i")).click()
