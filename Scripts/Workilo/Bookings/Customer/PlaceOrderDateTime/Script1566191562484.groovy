...
//    Thread.sleep(2000)
	...
	driver.findElement(By.xpath("//*[@id='tab-1']/div[1]/a")).click()
	...
	driver.findElement(By.xpath("//*[@id='ui-datepicker-div']/table/tbody/tr[5]/td[1]")).click()
	
	Thread.sleep(2000)
	
	Select selectStartTime = new Select(driver.findElement(By.id("start_hours")))
	
	selectStartTime.selectByValue("10")
