...
driver.findElement(By.id('email_login')).sendKeys('worker@gmail.com')
...
driver.findElement(By.id("imgInp")).sendKeys(imagePath)

Thread.sleep(3000)

driver.findElement(By.name("shop_name")).clear()

driver.findElement(By.name("shop_name")).sendKeys("My Shop")

Thread.sleep(2000)

driver.findElement(By.name("contact")).clear()

driver.findElement(By.name("contact")).sendKeys("7445522196")
...
driver.findElement(By.name("user_zip")).clear()

driver.findElement(By.name("user_zip")).sendKeys("10055")

driver.findElement(By.name("city")).clear()

driver.findElement(By.name("city")).sendKeys("Brooklyn")

driver.findElement(By.xpath("//*[@id='addshop']/div/div/ul/li[8]/input")).click()

WebElement alertMesssage = driver.findElement(By.xpath("/html/body/div[5]/div/div/div/div[1]"))

Thread.sleep(5000)

js.executeScript('arguments[0].style.border=\'3px solid red\'', alertMesssage)

//driver.findElement(By.xpath('/html/body/div[4]/div/div[1]/ul/li[4]/a')).click()

driver.findElement(By.name('title')).sendKeys('My Home Appliances')
