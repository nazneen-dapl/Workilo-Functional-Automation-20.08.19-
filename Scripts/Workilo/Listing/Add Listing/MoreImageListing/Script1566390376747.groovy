...
driver.findElement(By.name('title')).sendKeys('Homes Appliances')
...
//driver.findElement(By.xpath("//*[@id='addlist']/div[1]/div[12]/div[1]/a")).click()

//driver.findElement(By.xpath("//*[@id='addlist']/div[1]/div[12]/div[1]/a")).click()

driver.findElement(By.id('img_up_1')).sendKeys(imagePath)

driver.findElement(By.id('img_up_2')).sendKeys(imagePath)

driver.findElement(By.id('img_up_3')).sendKeys(imagePath)

driver.findElement(By.id('img_up_4')).sendKeys(imagePath)

driver.findElement(By.id('img_up_5')).sendKeys(imagePath)
